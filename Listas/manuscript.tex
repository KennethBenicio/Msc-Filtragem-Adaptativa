		...
		\begin{enumerate}
			...
			\item Seja o canal de comunicações dado por
				...
				\begin{figure}[H]
					...
					\caption{Caminho de convergência na superficie MSE para o NLMS. $\text{Amostras} = 1000$, $M = 2$, $\mu = 10^{-3}$}
	...
	\section*{Método de Mínimos Quadrados}
		...
		\begin{enumerate}
			...
			instabilidade numérica. Repita o procedimento como preditor de ordem 3.
				...
				Os resultados podem ser encontrados nas Figuras \ref{fig:L4Q3_a1} - \ref{fig:L4Q3_a8}.
			...
			dado por $W(z) = w_{0} + w_{1} z^{-1}$. (Problema da lista de exercícios no. 3).
				...
				\begin{enumerate}
					...
					\item Obtenha também a evolução do erro quadrático médio para cada um dos algoritmos anteriores.
						...
						As evolução do erro quadrático medio para os algoritmos Newton, Gradiente, LMS e NLMS já foram abordadas na seção 
						anterior e podem ser revisitadas nas Figuras \ref{fig:newton_mse}, \ref{fig:gradient_mse}, \ref{fig:lms_mse} e \ref{fig:nlms_mse}.
						adicionalmente, o traçado MSE para o método RLS está presente na Figura \ref{fig:rls_mse}.
