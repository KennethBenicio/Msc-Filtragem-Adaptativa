			...
			\item Utilize o algoritmo LMS para identiﬁcar um sistema com a função de transferência dada abaixo.
				...
				\begin{enumerate}
					...
					\item Mostre o gráﬁco da resposta em frequência do ﬁltro FIR em qualquer uma das iterações após a convergência ser obtida e compare com o sistema desconhecido.
						...
						\paragraph{}A resposta em frequência do filtro está disponível na Figura \ref{fig:filter_response} para o caso $\frac{\mu_{\text{max}}}{50}$. É possível ver que a resposta em frequência do filtro
			...
			\item Seja o canal de comunicações dado por
				...
				\begin{enumerate}
					...
					usando o LMS-normalizado e 500 símbolos de treinamento.					
						...
						tratar de uma modulação de ordem elevada, o filtro consegue se aproximar com um pouco mais de facilidade do sinal original. Adicionalmente, para termos uma melhor interpretação do desempenho desse filtro seria necessário utilizar 
						uma métrica como a SER ou BER e comparar o impacto de diferentes modulações no desempenho do algoritmo de filtragem. Tal procedimento será desenvolvido em sequência. 
